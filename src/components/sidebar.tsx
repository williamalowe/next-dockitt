  ...
  const taskLists = [
    {
      ...
      count: tasks.filter((task: any) => task.status === "backlog").length,
    },
    {
      href: "/in-progress",
      title: "In Progress",
      ...
      count: tasks.filter((task: any) => task.status === "in progress").length,
    },
    {
      href: "/under-review",
      title: "Under Review",
      ...
      count: tasks.filter((task: any) => task.status === "under review").length,
    },
    {
      href: "/completed",
      title: "Completed",
    ...
    },
    {
      ...
      count: tasks.filter((task: any) => task.status === "cancelled").length,
    },
  ];
  return (
    <>

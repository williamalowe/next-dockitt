  ...
  const taskLists = [
    {
      ...
      count: tasks.filter((task: any) => task.status === "backlog").length || 0,
    },
    {
      href: "/in-progress",
      title: "In Progress",
      ...
      count: tasks.filter((task: any) => task.status === "in progress").length || 0,
    },
    {
      href: "/under-review",
      title: "Under Review",
      ...
      count: tasks.filter((task: any) => task.status === "under review").length || 0,
    },
    {
      href: "/completed",
      title: "Completed",
      ...
      count: tasks.filter((task: any) => task.status === "completed").length || 0,
    },
    {
      href: "/cancelled",
      title: "Cancelled",
      ...
      count: tasks.filter((task: any) => task.status === "cancelled").length || 0,
    },
  ];
  return (
    <>
